    ...
    <div className="h-screen relative overflow-hidden">
      ...
      <div className="flex flex-col justify-end h-screen absolute bottom-0 w-full ">
        ...
        <div className="fixed z-10 bottom-0 bg-white px-3 py-6 w-full">
          ...
          <div className="mb-2 border-2 hover:border-black rounded-xl p-3 w-full flex items-center justify-between">
              <img
          className="h-20"
        ...
        />
          ...
          <div className="mb-2 border-2 active:border-black rounded-xl p-3 w-full flex items-center justify-between">
              <img
